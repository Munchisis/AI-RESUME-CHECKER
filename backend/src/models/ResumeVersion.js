...
const parseSectionSchema = new mongoose.Schema(
  {
    basics: { type: basicSchema, default: () => ({}) },
    summary: { type: String, default: "" },
    experiences: { type: [experienceItemSchema], default: [] },
    educations: { type: [educationItemSchema], default: [] },
...
const resumeVersionSchema = new mongoose.Schema(
  {
    ...
    parseSection: { type: parseSectionSchema, default: () => ({}) },
    sourceType: {
      type: String,
      enum: ["upload", "rewrite"],
      required: true,
